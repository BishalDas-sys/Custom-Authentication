...
<body>
    ...
    <div class="container">
    <a class="navbar-brand" href="#">Custom Authentication & CRUD </a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('update-employee/'.$employee->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <label for="">Employee Profile Image</label>
                            <input type="file" name="image" class="form-control">
                            <img src="{{ asset('storage/images/'.$employee->image) }}" width="70px" height="70px" alt="Image">
                        </div>
                        <div class="form-group mb-3">
